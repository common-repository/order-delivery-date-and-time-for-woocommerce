<?php
/**
 * Order Delivery Date and Time for WooCommerce Lite
 *
 * Settings added for the plugin in the admin
 *
 * @author      balasahebbhise
...
class orddd_lite_settings {
    ...
    public static function orddd_lite_order_delivery_date_menu() {
        add_menu_page('Order Delivery Date Time', 'Order Delivery Date Time', 'manage_woocommerce', 'order_delivery_date_lite', array('orddd_lite_settings', 'orddd_lite_order_delivery_date_settings'));
    }
    ...
    public static function order_lite_delivery_date_admin_settings() {
        ...
        add_settings_section(
                ...
                __('Order Delivery Date and Time Settings', 'order-delivery-date'), // Title to be displayed on the administration page
        ...
        add_settings_field(
                'orddd_lite_enable_delivery_date', __('Enable Delivery Date:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_enable_delivery_date_callback'), 'orddd_lite_date_settings_page', 'orddd_lite_date_settings_section', array(__('Enable Delivery Date capture on the checkout page.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_delivery_days', __('Delivery Days:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_delivery_days_callback'), 'orddd_lite_date_settings_page', 'orddd_lite_date_settings_section', array('&nbsp;' . __('Select weekdays for delivery.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_minimumOrderDays', __('Minimum Delivery time (in hours):', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_minimum_delivery_time_callback'), 'orddd_lite_date_settings_page', 'orddd_lite_date_settings_section', array(__('Minimum number of hours required to prepare for delivery.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_number_of_dates', __('Number of dates to choose:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_number_of_dates_callback'), 'orddd_lite_date_settings_page', 'orddd_lite_date_settings_section', array(__('Number of dates available for delivery.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_date_field_mandatory', __('Mandatory field?:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_date_field_mandatory_callback'), 'orddd_lite_date_settings_page', 'orddd_lite_date_settings_section', array(__('Selection of delivery date on the checkout page will become mandatory.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_lockout_date_after_orders', __('Lockout date after X orders:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_lockout_date_after_orders_callback'), 'orddd_lite_date_settings_page', 'orddd_lite_date_settings_section', array(__('Maximum deliveries/orders per day.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_enable_default_sorting_of_column', __('Sort on WooCommerce Orders Page:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_enable_default_sorting_of_column_callback'), 'orddd_lite_date_settings_page', 'orddd_lite_date_settings_section', array(__('Enable default sorting of orders (in descending order) by Delivery Date on WooCommerce -> Orders page', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_auto_populate_first_available_date', __('Auto-populate first available Delivery date:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_auto_populate_first_available_date_callback'), 'orddd_lite_date_settings_page', 'orddd_lite_date_settings_section', array(__('Auto-populate first available Delivery date when the checkout page loads.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_calculate_min_time_disabled_days', __('Apply Minimum Delivery Time for non working weekdays:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_calculate_min_time_disabled_days_callback'), 'orddd_lite_date_settings_page', 'orddd_lite_date_settings_section', array(__('If selected, then the Minimum Delivery Time (in hours) will be applied on the non working weekdays which are unchecked in Delivery Weekdays. If unchecked, then it will not be applied. For example, if Minimum Delivery Time (in hours) is set to 48 hours and Saturday is disabled for delivery. Now if a customer visits the website on Firday, then the first available date will be Monday and not Sunday.', 'order-delivery-date'))
        );

        foreach ($orddd_lite_weekdays as $n => $day_name) {
            register_setting(
                    'orddd_lite_date_settings', $n
            );
        }

        register_setting(
                'orddd_lite_date_settings', 'orddd_lite_enable_delivery_date'
        );

        register_setting(
                'orddd_lite_date_settings', 'orddd_lite_minimumOrderDays'
        );

        register_setting(
                'orddd_lite_date_settings', 'orddd_lite_number_of_dates'
        );

        register_setting(
                'orddd_lite_date_settings', 'orddd_lite_date_field_mandatory'
        );

        register_setting(
                'orddd_lite_date_settings', 'orddd_lite_lockout_date_after_orders'
        );

        register_setting(
                'orddd_lite_date_settings', 'orddd_lite_enable_default_sorting_of_column'
        );

        register_setting(
                'orddd_lite_date_settings', 'orddd_lite_auto_populate_first_available_date'
        );

        register_setting(
                'orddd_lite_date_settings', 'orddd_lite_calculate_min_time_disabled_days'
        );
     ...
     * @since 1.5
     */
    public static function order_lite_delivery_time_admin_settings() {


        add_settings_section(
                'orddd_lite_time_section', __('Time Appearance', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_time_admin_setting_callback'), 'orddd_lite_time_page'
        );
        add_settings_field(
                'orddd_lite_delivery_time_field_label', __('Field Label:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_delivery_time_field_label_callback'), 'orddd_lite_time_page', 'orddd_lite_time_section', array(__('Choose the label that is to be displayed for the time field on checkout page. EX. Delivery Time', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_delivery_time_field_options', __('Field Options:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_delivery_time_field_options_callback'), 'orddd_lite_time_page', 'orddd_lite_time_section', array(__('Add the options cam by saparated that is to be displayed for the time field on checkout page.  EX.8 AM to 10 AM, 10 AM to 12 PM, 12 PM to 2 PM, 2 PM to 4 PM, 4 PM to 6 PM, 6 PM to 8 PM ', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_delivery_time_field_values', __('Field Values:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_delivery_time_field_values_callback'), 'orddd_lite_time_page', 'orddd_lite_time_section', array(__('Add the values cam by saparated  the values that is to be displayed for the field on checkout page.  EX. 8 AM to 10 AM, 10 AM to 12 PM, 12 PM to 2 PM, 2 PM to 4 PM, 4 PM to 6 PM, 6 PM to 8 PM', 'order-delivery-date'))
        );

        register_setting(
                'orddd_lite_time_settings', 'orddd_lite_delivery_time_field_label'
        );
        register_setting(
                'orddd_lite_time_settings', 'orddd_lite_delivery_time_field_options'
        );
        register_setting(
                'orddd_lite_time_settings', 'orddd_lite_delivery_time_field_values'
        );
    }
    ...
    public static function order_lite_appearance_admin_settings() {
        add_settings_section(
                'orddd_lite_appearance_section', __('Calendar Appearance', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_appearance_admin_setting_callback'), 'orddd_lite_appearance_page'
        );

        add_settings_field(
                'orddd_lite_language_selected', __('Calendar Language:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_appearance_calendar_language_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array(__('Choose a Language.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_delivery_date_format', __('Date Format:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_appearance_date_formats_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array('<br>' . __('The format in which the Delivery Date appears to the customers on the checkout page once the date is selected.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_start_of_week', __('First Day of Week:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_appearance_first_day_of_week_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array(__('Choose the first day of week displayed on the Delivery Date calendar.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_delivery_date_field_label', __('Field Label:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_delivery_date_field_label_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array(__('Choose the label that is to be displayed for the field on checkout page.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_delivery_date_field_placeholder', __('Field Placeholder Text:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_delivery_date_field_placeholder_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array(__('Choose the placeholder text that is to be displayed for the field on checkout page.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_delivery_date_field_note', __('Field Note Text:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_delivery_date_field_note_text_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array('<br>' . __('Choose the note to be displayed below the delivery date field on checkout page.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_number_of_months', __('Number of Months:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_appearance_number_of_months_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array(__('The number of months to be shown on the calendar.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_delivery_date_fields_on_checkout_page', __('Field placement on the Checkout page:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_delivery_date_in_shipping_section_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array(__('</br>The Delivery Date field will be displayed in the selected section.</br><i>Note: WooCommerce automatically hides the Shipping section fields for Virtual products.</i>', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_delivery_date_on_cart_page', __('Delivery Date field on Cart page:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_delivery_date_on_cart_page_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array(__('Add the Delivery Date field on the cart page along with the Checkout page.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_calendar_theme_name', __('Theme:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_appearance_calendar_theme_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array(__('Select the theme for the calendar which blends with the design of your website.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_no_fields_for_product_type', __('Disable the Delivery Date Field for:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_appearance_virtual_product_callback'), 'orddd_lite_appearance_page', 'orddd_lite_appearance_section', array(__('<br>Disable the Delivery Date on the Checkout page for Virtual products and Featured products.', 'order-delivery-date'))
        );



        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_language_selected'
        );
        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_language_selected'
        );
        ...
        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_delivery_date_format'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_start_of_week'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_delivery_date_field_label'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_delivery_date_field_placeholder'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_delivery_date_field_note'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_number_of_months'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_delivery_date_fields_on_checkout_page'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_delivery_date_on_cart_page'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_calendar_theme_name'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_calendar_theme'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_no_fields_for_virtual_product'
        );

        register_setting(
                'orddd_lite_appearance_settings', 'orddd_lite_no_fields_for_featured_product'
        );
    }
    ...
    public static function order_lite_holidays_admin_settings() {
        // First, we register a section. This is necessary since all future options must belong to one.
        add_settings_section(
                'orddd_lite_holidays_section', __('Add Holiday', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_holidays_admin_settings_callback'), 'orddd_lite_holidays_page'
        );

        add_settings_field(
                'orddd_lite_holiday_name', __('Name:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_holidays_name_callback'), 'orddd_lite_holidays_page', 'orddd_lite_holidays_section', array(__('Enter the name of the holiday here.', 'order-delivery-date'))
        );

        add_settings_field(
                'orddd_lite_holiday_date', __('Date:', 'order-delivery-date'), array('orddd_lite_settings', 'orddd_lite_holidays_date_callback'), 'orddd_lite_holidays_page', 'orddd_lite_holidays_section', array(__('Select the holiday date here.', 'order-delivery-date'))
        );

        register_setting(
                'orddd_lite_holidays_settings', 'orddd_lite_holidays', array('orddd_lite_settings', 'orddd_lite_holidays_callback')
        );
    }
    ...
    public static function orddd_lite_order_delivery_date_settings() {
        ...
        if ($action == 'time') {
            $active_time_settings = "nav-tab-active";
        }
        ...
        <h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
            ...
            <a href="admin.php?page=order_delivery_date_lite&action=time" class="nav-tab <?php echo $active_time_settings; ?>"><?php _e('Time Settings', 'order-delivery-date-time'); ?> </a>
        ...
        if ($action == 'date' || $action == '') {
            ...
            print( '<div id="content">
                <form method="post" action="options.php">');
            settings_fields("orddd_lite_time_settings");
            do_settings_sections("orddd_lite_time_page");
     ...
     * @since 1.5
     */
    public static function orddd_lite_time_admin_setting_callback() {
    ...
    public static function orddd_lite_appearance_date_formats_callback($args) {
        ...
        foreach ($orddd_lite_date_formats as $k => $format) {
            printf("<option %s value='%s'>%s</option>\n", selected($k, get_option('orddd_lite_delivery_date_format'), false), esc_attr($k), date($format)
            );
        }
        echo '</select>';
     ...
     * @since 1.5
     */
    public static function orddd_lite_delivery_time_field_label_callback($args) {
        echo '<input type="text" name="orddd_lite_delivery_time_field_label" id="orddd_lite_delivery_time_field_label" value="' . get_option('orddd_lite_delivery_time_field_label') . '" maxlength="100"/>';

        $html = '<label for="orddd_lite_delivery_time_field_label"> ' . $args[0] . '</label>';
        echo $html;
    }

    public static function orddd_lite_delivery_time_field_options_callback($args) {
        echo '<input type="text" name="orddd_lite_delivery_time_field_options" id="orddd_lite_delivery_time_field_options" value="' . get_option('orddd_lite_delivery_time_field_options') . '" />';

        $html = '<label for="orddd_lite_delivery_time_field_options"> ' . $args[0] . '</label>';
        echo $html;
    }

    public static function orddd_lite_delivery_time_field_values_callback($args) {
        echo '<input type="text" name="orddd_lite_delivery_time_field_values" id="orddd_lite_delivery_time_field_values" value="' . get_option('orddd_lite_delivery_time_field_values') . '" />';

        $html = '<label for="orddd_lite_delivery_time_field_values"> ' . $args[0] . '</label>';
        echo $html;
    }
    ...
    public static function orddd_lite_appearance_number_of_months_callback($args) {
        ...
        foreach ($orddd_lite_number_of_months as $k => $v) {
            printf("<option %s value='%s'>%s</option>\n", selected($k, get_option('orddd_lite_number_of_months'), false), esc_attr($k), $v
            );
        }
        echo '</select>';
                ...
                jQuery( "#switcher" ).themeswitcher( {
                    onclose: function( ) {
                        ...
                        jQuery( "<link/>", {
                            rel: "stylesheet",
                            type: "text/css",
                            href: "' . esc_url(plugin_dir_url(__FILE__) . "../../css/datepicker.css") . '"
                        }).appendTo("head");
                    },
                    imgpath: "' . esc_url(plugin_dir_url(__FILE__) . '../../images/') . '",
    ...
    public static function orddd_lite_delete_settings() {
        if (( isset($_GET['page']) && $_GET['page'] == 'order_delivery_date_lite' ) && ( isset($_GET['tab']) && $_GET['tab'] == 'holidays' ) && ( ( isset($_GET['action']) && $_GET['action'] == 'orddd_lite_delete' ) || ( isset($_GET['action2']) && $_GET['action2'] == 'orddd_lite_delete' ) )) {
            ...
            if (isset($_GET['holiday'])) {
                foreach ($_GET['holiday'] as $key => $value) {                    
                    $holiday[$key] = sanitize_text_field($value);                    
                }
            }
