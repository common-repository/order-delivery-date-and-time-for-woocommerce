	...
	class Orddd_Lite_All_Component {
		...
		public function __construct() {
			...
			if ( true === $is_admin ) {
                ...
                $orddd_lite_file_name            = 'order-delivery-date-time-for-woocommerce/order_delivery_date.php';
                $orddd_lite_plugin_prefix        = 'orddd_lite';
                $orddd_lite_lite_plugin_prefix   = 'orddd_lite';
                $orddd_lite_plugin_folder_name   = 'order-delivery-date-time-for-woocommerce/';
                ...
                $orddd_lite_blog_post_link       = ' https://profiles.wordpress.org/balasahebbhise/';
        ...
        public static function orddd_lite_get_faq () {
            ...
            $ts_faq = array(
                1 => array (
                        ...
                        'answer'   => 'It is not possible to add Delivery date calendar for each product from Order Delivery Date for WooCommerce. However, we do have a plugin name <a href="https://profiles.wordpress.org/balasahebbhise/" rel="nofollow">Product Delivery Date for WooCommerce Pro</a> and <a href="https://wordpress.org/plugins/product-delivery-date-for-woocommerce-lite/">Lite</a> version both.'
                    ), 
                2 => array (
                        'question' => 'Can the customer enter the preferred order delivery time?',
                        'answer'   => 'Currently, there is no provision for entering the delivery time in the free version. This is possible in the Pro version. <a href="https://profiles.wordpress.org/balasahebbhise/" title="View Demo" rel="nofollow">View Demo</a>.'
                    ),
                3 => array (
                ...
                5 => array (
						...
						'answer'   => 'Currently, it is not possible to add the extra charges for deliveries on weekdays or for specific dates in the free version. However, this feature is available in the <a href="https://profiles.wordpress.org/balasahebbhise/" rel="nofollow">Order Delivery Date Pro for WooCommerce plugin</a>.'
                ),
                6 => array (
                ...
                8 => array (
						...
						'answer'   => 'Currently, it is not possible to edit the selected delivery date for the WooCommerce orders in the free version. However, this feature is available in the <a href="https://profiles.wordpress.org/balasahebbhise/" rel="nofollow">Order Delivery Date Pro for WooCommerce plugin</a>. The admin, as well as the customers, can edit the delivery date for the already placed WooCommerce orders.'
                ),
                9 => array (
						'question' => 'Can we set different delivery settings for different shipping methods or different product categories?',
						'answer'   => 'Currently, it is not possible to add different delivery settings for different shipping methods or different products categories in the free version. However, this feature is available in the <a href="https://profiles.wordpress.org/balasahebbhise/" rel="nofollow">Order Delivery Date Pro for WooCommerce plugin</a>.'
                ),
                10 => array (
						'question' => 'Difference between Lite and Pro version of the plugin.',
						'answer'   => 'You can refer <strong><a href="https://profiles.wordpress.org/balasahebbhise/" title="Lite and Pro version Difference" rel="nofollow">here</a>.'
                )    
            );
