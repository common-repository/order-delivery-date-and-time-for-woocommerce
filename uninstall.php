<?php
/**
 * Order Delivery Date and Time Lite Uninstall
 *
...
delete_option( 'orddd_lite_delivery_time_field_label' );
delete_option( 'orddd_lite_delivery_time_field_options' );
delete_option( 'orddd_lite_delivery_time_field_values' );
