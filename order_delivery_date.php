<?php 
/*
Plugin Name: Order Delivery Date and Time for WooCommerce
Description: This plugin allows customers to choose their preferred Order Delivery Date and Time during checkout.
Author: Balasaheb Bhise
Version: 1.0
Author URI: https://profiles.wordpress.org/balasahebbhise/
Contributor: balasahebbhise
...
if ( !class_exists( 'order_delivery_date_lite' ) ) {
    ...
    class order_delivery_date_lite {
        ...
        public function __construct() {
            ...
            add_action( 'admin_init', array( 'orddd_lite_settings', 'order_lite_delivery_time_admin_settings' ) );
        ...
        function orddd_lite_activate() {
            ...
            // time options
            add_option( 'orddd_lite_delivery_time_field_label', ORDDD_LITE_DELIVERY_TIME_FIELD_LABEL );
            add_option( 'orddd_lite_delivery_time_field_options', ORDDD_LITE_DELIVERY_TIME_FIELD_OPTIONS );
            add_option( 'orddd_lite_delivery_time_field_values', ORDDD_LITE_DELIVERY_TIME_FIELD_VALUES );
...
// appearance options
        ...
        function orddd_lite_my_enqueue( $hook ) {
            ...
            wp_localize_script('themeswitcher-orddd', 'themeswitcherOrddd', array(
            ...
            if( file_exists(WP_PLUGIN_DIR . '/woocommerce/assets/css/admin.css') ) {
